...
var store = new _vuex.default.Store({
  ...
  mutations: {
    getopenid: function getopenid(state, provider) {
    ...
    openidout: function openidout(state) {
    ...
    memberLoginout: function memberLoginout(state) {//注册会员的注销
