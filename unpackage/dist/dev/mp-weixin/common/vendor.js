...
function login(opts) {
  ...
  getWxLoginResult(function (err, loginResult) {var _header;
    if (err) {
      return opts.fail(err);
    }

    // 构造请求头，包含 code、encryptedData 和 iv
    var header = (_header = {}, _defineProperty(_header,
    constants.WX_HEADER_CODE, loginResult.code), _defineProperty(_header,
    constants.WX_HEADER_ENCRYPTED_DATA, loginResult.encryptedData), _defineProperty(_header,
    constants.WX_HEADER_IV, loginResult.iv), _header);
    ...
    wx.request({
      ...
      success: function success(result) {
        ...
        if (!data || data.code !== 0 || !data.data || !data.data.skey) {
          return opts.fail(new Error("\u54CD\u5E94\u9519\u8BEF\uFF0C".concat(JSON.stringify(data))));
        }

        var res = data.data;

        if (!res || !res.userinfo) {
          return opts.fail(new Error("\u767B\u5F55\u5931\u8D25(".concat(data.error, ")\uFF1A").concat(data.message)));
        }
...
module.exports = { login: login, setLoginUrl: setLoginUrl, loginWithCode: loginWithCode };
...
function Tunnel(serviceUrl) {
  ...
  function openConnect() {
    ...
    requestLib.request({
      ...
      complete: function complete() {return isOpening = false;} });
...
var noop = function noop() {return void 0;};

var onOpen, onClose, onMessage, onError;
...
/* istanbul ignore next */
function bind() {
  wx.onSocketOpen(function (result) {return onOpen(result);});
  wx.onSocketClose(function (result) {return onClose(result);});
  wx.onSocketMessage(function (result) {return onMessage(result);});
  wx.onSocketError(function (error) {return onError(error);});
}
...
/***/ 13:
/*!***************************************************!*\
  !*** F:/陈星的微信小程序/英度云商（重构）/pages/utils/request.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.get = get;exports.post = post;exports.toLogin = toLogin;exports.login = login;exports.memberlogin = memberlogin;exports.getStorageOpenid = getStorageOpenid;exports.default = exports.host = void 0;
//-------------------------------------------------------------------------原始的写法

//临时用
var host = 'http://www.jingsoftware.com:4430';exports.host = host;
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    vuelogout: function vuelogout(state) {
...
/***/ 7:
/*!********************************************************!*\
  !*** F:/陈星的微信小程序/英度云商（重构）/pages.json?{"type":"style"} ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 8:
/*!*******************************************************!*\
  !*** F:/陈星的微信小程序/英度云商（重构）/pages.json?{"type":"stat"} ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
