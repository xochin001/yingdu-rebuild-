...

{
  ...
  (0, _vuex.mapState)(['userInfo', 'time', 'hastime', 'memberdata'])),
  ...
  methods: {
    submit: function submit(e) {var _this = this;
      ...
      if (checkRes) {
        ...
        this.getmemberuser(this.userInfo).then(function (pres) {//验证通过后，重新从数据库获取会员数据并赋值给页面。
    ...
    checkphonenumber: function checkphonenumber(e) {
      ...
      var p = _graceChecker.default.check(e, rule);
      if (p) {
...
var _memberedit = _interopRequireDefault(__webpack_require__(/*! ./pages/memberedit/memberedit.vue */ 97));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _memberedit_vue_vue_type_template_id_003186c7_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./memberedit.vue?vue&type=template&id=003186c7&scoped=true& */ 98);
/* harmony import */ var _memberedit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./memberedit.vue?vue&type=script&lang=js& */ 100);
...
/* harmony import */ var _memberedit_vue_vue_type_style_index_0_id_003186c7_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./memberedit.vue?vue&type=style&index=0&id=003186c7&lang=scss&scoped=true& */ 102);
